...
<body style="margin:0;padding:0;">
	<div id="main_box" style="width:100%;">
		...
		<div id="head_content" style="width:100%;height:384px;overflow: hidden;">
				<img src="http://static.imzhitu.com/images/d4a_head_bg.jpg" style="width:100%;z-index:-9999;position:absolute;margin:auto;"/>
		...
		<div id="content" style="width:100%;height:795px;background-color:#f6f5ea;">
			...
			<div style="margin:0 auto;padding-top:20px;width:162px;height:284px;"><img src="http://static.imzhitu.com/images/d4a_desc_bg_1.jpg?ver=${webVer}" style="width:162px;height:284px;"/></div>
			...
			<div style="margin:0 auto;padding-top:20px;width:160px;height:284px;"><img src="http://static.imzhitu.com/images/d4a_desc_bg_2.jpg?ver=${webVer}" style="width:160px;height:284px;"/></div>
