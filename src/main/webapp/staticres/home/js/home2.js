...
var ui = {
	...
	initUserInfo : function(user) {
		...
		$("#user-avatar").attr("src", user["userAvatarL"]);
	...
	appendWorld : function(worlds) {
		...
		for(var i in worlds) {
			...
			$world = 
				...
				+ '<a class="opt-btn" href="/index4ph.html"><img src="/staticres/htworld/phonev3/images/icon-comment.png"/><span id="comment-count">'+ui.countformat(world["commentCount"])+'</span></a>'
				+ '</div>'
