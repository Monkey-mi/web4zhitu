 ...
 * 
 */
public class UserConcernDto implements Serializable, ObjectWithUserVerify, ObjectWithUserRemark {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3504956584028380690L;
	...
	public UserConcernDto() {
		super();
	}
	
	public UserConcernDto(Integer id, Integer userId, Integer concernId,
			Integer isMututal, Date concernDate, Integer ck, String userName,
