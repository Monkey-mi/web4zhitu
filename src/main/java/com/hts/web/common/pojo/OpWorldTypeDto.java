...
public class OpWorldTypeDto implements HTWorldWithExtra, ObjectWithUserVerify, ObjectWithUserRemark {
	...
	public OpWorldTypeDto(Integer recommendId, Integer recommendTypeId, Date recommendDate, String review, Integer id,
			...
			String titleThumbPath, List<HTWorldChannelName> channelNames, Double longitude, Double latitude,
			String locationDesc, String locationAddr, Integer phoneCode, String province, String city, Integer size,
