...
@Repository("HTSMsgAtWorldDao")
public class MsgAtWorldDaoImpl extends BaseDaoImpl implements MsgAtWorldDao {

private static String table = HTS.USER_MSG_AT_WORLD;
	
	private static final String SAVE_MSG = "insert into " + table
			+ "(id,world_id,at_id,at_name) values ";
